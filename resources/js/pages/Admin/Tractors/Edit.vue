    ...
    <div class="container mx-auto p-6">
      <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-green-800">
          Editar: {{ tractor.brand }} {{ tractor.model }}
        </h1>
        <div class="space-x-2">
          <Link 
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div class="lg:col-span-1">
                <div class="bg-gray-50 rounded-lg p-6">
                  ...
                  <!-- Imagen actual -->
                  <div v-if="tractor.image && !form.remove_image" class="mb-4">
                  ...
                  <div v-if="!imagePreview">
                    <label for="image" class="block text-sm font-medium text-gray-700 mb-2">
                      {{ tractor.image && !form.remove_image ? 'Cambiar imagen' : 'Subir imagen' }}
                    </label>
                    <input 
                      type="file" 
                      id="image" 
                  ...
                  <div v-if="!tractor.image && !imagePreview" class="mb-4">
                    <div class="w-full aspect-square rounded-lg bg-gray-100 border-2 border-dashed border-gray-300 flex items-center justify-center">
...
const submit = () => {
  ...
  if (form.horsepower) formData.append('horsepower', form.horsepower);
  if (form.working_hours) formData.append('working_hours', form.working_hours);
  formData.append('is_available', form.is_available ? '1' : '0');
  
  // Agregar usuarios
  selectedUsers.value.forEach((userId, index) => {
  ...
  router.post(route('tractors.update', props.tractor.id), formData, {
    forceFormData: true,
    onSuccess: () => {
      form.clearErrors();
    },
