    ...
    <div class="container mx-auto p-6">
      ...
      <form @submit.prevent="submit" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        ...
        <div class="flex items-center justify-between mt-6">
          ...
          >
            {{ form.processing ? 'Creando...' : 'Crear Anuncio' }}
          </button>
          <Link 
...
onMounted(() => {
  ...
  if (window.Inertia && window.Inertia.page.props.auth && window.Inertia.page.props.auth.user) {
    ...
    // Seleccionar el primer usuario como valor por defecto si no hay usuario autenticado
    form.seller_id = props.users[0].id;
  }
});
