<template>
  <div>
          ...
          <div class="flex">
            ...
            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
              <Link 
                ...
                :class="{'bg-green-800 text-yellow-400': route().current('user.dashboard')}"
              >
    ...
    <!-- Footer -->
    <footer class="bg-green-900 text-white py-8 border-t-4 border-yellow-600">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 class="text-lg font-semibold text-yellow-400 mb-4">TractorApp</h3>
            <p class="text-green-100 text-sm">
              Conectamos agricultores y proveedores de maquinaria agrícola en una plataforma sencilla y segura.
            </p>
          </div>
          <div>
            <h3 class="text-lg font-semibold text-yellow-400 mb-4">Enlaces Rápidos</h3>
            <ul class="space-y-2 text-sm">
              <li>
                <Link :href="route('home')" class="text-green-100 hover:text-yellow-400 transition">Inicio</Link>
              </li>
              <li>
                <Link :href="route('user.dashboard')" class="text-green-100 hover:text-yellow-400 transition">Panel de Control</Link>
              </li>
              <li>
                <Link :href="route('user.listings.index')" class="text-green-100 hover:text-yellow-400 transition">Anuncios</Link>
              </li>
              <li>
                <Link :href="route('contact')" class="text-green-100 hover:text-yellow-400 transition">Contacto</Link>
              </li>
            </ul>
          </div>
          <div>
            <h3 class="text-lg font-semibold text-yellow-400 mb-4">Categorías</h3>
            <ul class="space-y-2 text-sm">
              <li>
                <Link :href="route('user.listings.sales')" class="text-green-100 hover:text-yellow-400 transition">Tractores en Venta</Link>
              </li>
              <li>
                <Link :href="route('user.listings.rentals')" class="text-green-100 hover:text-yellow-400 transition">Tractores en Alquiler</Link>
              </li>
              <li>
                <a href="#" class="text-green-100 hover:text-yellow-400 transition">Aperos y Accesorios</a>
              </li>
            </ul>
          </div>
          <div>
            <h3 class="text-lg font-semibold text-yellow-400 mb-4">Contacto</h3>
            <ul class="space-y-2 text-sm">
        ...
        <div class="mt-8 pt-8 border-t border-green-800 text-center text-sm text-green-300">
          <p>&copy; {{ new Date().getFullYear() }} TractorApp. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  </div>
...
/* Add subtle field texture to the footer */
footer {
  background-image: 
    linear-gradient(to bottom, rgba(20, 83, 45, 0.98), rgba(20, 83, 45, 0.98)),
